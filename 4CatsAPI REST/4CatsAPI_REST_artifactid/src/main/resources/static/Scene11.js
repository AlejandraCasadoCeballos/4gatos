class Scene11 extends Phaser.Scene{
    ...
    create(){
        ...
        //BOTON JUGAR
        botonMungojerry.on('pointerdown', () => { this.scene.start("Menu"); jugador.nombre="mungojerry"; POSTservidor(jugador); });
        ...
        //BOTON CRÉDITOS
        botonMuffin.on('pointerdown', () => { this.scene.start("Menu"); jugador.nombre="muffin"; POSTservidor(jugador);});
