...
public class Jugador {
	...
	public Jugador(long id,String nombre, LocalDateTime momentoDeRegistro, LocalDateTime ultimaInteraccion, String nombreJugador, boolean parejaEncontrada, boolean enSala, String escenario, boolean fueraSala ) {	
		super();
	...
	public Jugador salaEspera(Jugador jugadorActualizado) {
		Jugador jugadorEmparejado=new Jugador();
		if(jugadorActualizado.getEnSala()==true) {
	        if( jugadorActualizado.getNombreDelGato().equals("Muffin") ) { // no entiendo porque no me detecta esto me cago en todo
	            for(long i: JugadorController.jugadores.keySet()) {
	                	...
	                	JugadorController.jugadores.get(i).getEnSala()==true) 
	                 {
	                	JugadorController.jugadores.get(i).setParejaEncontrada(true);
	                   	...
	                   	jugadorEmparejado=JugadorController.jugadores.get(i);
		...
		if(jugadorActualizado.getFueraSala()) 
		{
			jugadorEmparejado.setFueraSala(true);
		}
