class Scene7 extends Phaser.Scene{
    ...
    create(){
        ...
        botonMenu.on('pointerdown', () => {musica2.stop(); DELETEservidor(jugador);this.scene.stop("Juego"); musica.stop(); this.scene.switch("Menu"); jugador.fueraSala=true; PUTservidor(jugador); });
