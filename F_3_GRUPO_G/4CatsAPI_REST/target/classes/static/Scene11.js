class Scene11 extends Phaser.Scene
{
    ...
    create()
    {
        ...
        this.physics.add.collider(mungojerry, plataformaGorda);
   	 	...
   	 	botonAtras.on('pointerdown', () => { this.scene.start("elegirEscenario"); escenarioUno=false; escenarioDos=false; escenarioTres=false; jugador.escenario="";PUTservidor(jugador);});
