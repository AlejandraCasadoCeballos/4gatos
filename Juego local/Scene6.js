class Scene6 extends Phaser.Scene{
    ...
    create(){
    	...
    	botonAtras.on('pointerdown', () => { this.scene.start("Menu");});
    	...
    	botonEscenario1.on('pointerdown', () => { this.scene.start("Mensaje"); escenarioUno=true;});
    	...
    	botonEscenario2.on('pointerdown', () => { this.scene.start("Mensaje"); escenarioDos=true;});
    	...
    	botonEscenario3.on('pointerdown', () => { this.scene.start("Mensaje"); escenarioTres=true;});
