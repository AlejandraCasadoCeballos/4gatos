class Scene3 extends Phaser.Scene{
    ...
    { 
        ...
        platforms.create(400, 600, 'plataforma').setScale(2, 0.70).refreshBody().setAlpha(0.2); //cargarmos la imagen multiplicando por 2 su tamaño

        platforms.create(120, 240, 'plataforma').setScale(0.25, 0.3).refreshBody().setAlpha(0.2);//farola
        platforms.create(120, 50, 'plataforma').setScale(0.25, 0.3).refreshBody().setAlpha(0.2);//ventilador1
        platforms.create(640, 190, 'plataforma').setScale(0.33, 0.3).refreshBody().setAlpha(0.2);//venta izquierda

        platforms.create(340, 190, 'plataforma').setScale(0.33, 0.3).refreshBody().setAlpha(0.2);//ventana derecha

        platforms.create(339, 367, 'plataforma').setScale(0.33, 0.3).refreshBody().setAlpha(0.2);//ventana centro
        platforms.create(512, 347, 'plataforma').setScale(0.23, 0.3).refreshBody().setAlpha(0.2);//ventilador bajo
        platforms.create(640, 480, 'plataforma').setScale(0.5, 0.3).refreshBody().setAlpha(0.2);//basura
        platforms.create(90, 480, 'plataforma').setScale(0.3, 0.3).refreshBody().setAlpha(0.2);//coche
        platforms.create(180, 520, 'plataforma').setScale(0.2, 0.3).refreshBody().setAlpha(0.2);//coche
        platforms.create(1, 1, 'plataforma').setScale(0.15, 200).refreshBody().setAlpha(0.2); //cargarmos la imagen multiplicando por 2 su tamaño
        platforms.create(800, 800, 'plataforma').setScale(0.15, 200).refreshBody().setAlpha(0.2);
        ...
        this.anims.create({
            ...
            frames: this.anims.generateFrameNumbers('Muffin', { start: 0, end: 7 }),
            frameRate: 20,
